...
// Export the old interface for backward compatibility during migration if needed, 
// but we will primarily use OpeningVariation for the "leaf" nodes.
export type Opening = OpeningVariation;

export const initialOpeningCategories: OpeningCategory[] = [
    {
        id: 'kings-pawn',
        name: 'Kings Pawn Opening (E4)',
        groups: [
            {
                id: 'sicilian',
                name: 'Sicilian Defense',
                description: 'e4 c5 - Black Queen side bishops pawn comes out (Most popular response)',
                variations: [
                    {
                        id: 'sicilian-najdorf',
                        name: 'Mainline (Najdorf)',
            ...
            {
                id: 'open-games',
                name: 'Symmetric Kings Pawn (e4 e5)',
                variations: [
                    {
                        id: 'ruy-lopez',
                        name: 'Ruy Lopez',
                    ...
                    },
                    {
                        ...
                        description: 'A sharp and aggressive opening for White.',
                    ...
                    },
                    {
                        id: 'danish-gambit',
                        name: 'Danish Gambit',
                        description: 'Sacrifice two pawns for rapid development.',
                    ...
                    },
                    {
                        id: 'kings-gambit',
                        name: 'King\'s Gambit',
                        description: 'The romantic era favorite.',
                    ...
                    },
                    {
                        id: 'evans-gambit',
                        name: 'Evans Gambit',
                        description: 'Sacrifice the b-pawn in the Italian Game.',
                ...
                variations: [
                    {
                        ...
                        description: 'Hypermodern defense where Black allows White a strong center.',
...
// Helper to flatten for backward compatibility or searching
export const initialOpenings: OpeningVariation[] = initialOpeningCategories.flatMap(cat =>
    cat.groups.flatMap(group => group.variations)
);
